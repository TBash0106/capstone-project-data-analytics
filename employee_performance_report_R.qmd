...
This study addresses a single guiding question: **what are the key drivers of employee performance at Argentil, and how do individual, organisational, and developmental factors influence performance outcomes over time?** Argentil's lean, specialised workforce across investment banking, principal investing, and asset management means every individual outcome compounds, making it essential to know which factors actually impact performance. The analysis uses a longitudinal panel of **31 employees across six half-yearly review periods (2023 H1 – 2025 H2; 153 records)** from the HPC Power BI report and HRIS, applying five techniques (EDA, Visualisation, Hypothesis Testing, Correlation, OLS Regression) with two additions: manager-level variance analysis and an employee fixed-effects robustness check.
